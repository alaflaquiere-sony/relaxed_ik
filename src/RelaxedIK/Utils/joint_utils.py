...
if __name__ == "__main__":
    q, k = interpolate_to_joint_limits([-0.1, 0.3, 0], [-0.2, 0.3, 0.1], numDOF=3, joint_limits=[3.15, 6.0, 3.15])
    print(check_legal_velocity([-0.1, 0.3, 0], [-0.1, 0.4, 0.07], numDOF=3, t=0.02, joint_limits=[3.15, 6.0, 3.15]))
