...
class PreprocessorEngine:
    ...
    def load_input_and_output_pairs(self, num_samples=40000):
        ...
        for i in range(len(self.yoshikawa_scores)):
            ...
            if self.yoshikawa_scores[i] < split_point:
                self.in_singularity.append(-1.0)
            else:
                self.in_singularity.append(1.0)
    ...
    def train_nn(self, layer_width=15, num_layers=5, input_samples=200000, init_load=True):
        ...
        hls = tuple(hls)
        clf = MLPRegressor(
            solver="adam", alpha=1, hidden_layer_sizes=hls, max_iter=300000, verbose=True, learning_rate="adaptive"
        )
    ...
    def evaluate(self, num_samples=1000, split_point=5.0):
        ...
        return (
            false_positive_count / total_count,
            false_negative_count / total_count,
    ...
    def find_optimal_split_point(self, num_samples=1000):
        ...
        best_split = 5.0
        best_split_score = 100000000000.0
        split_point = 8.0
