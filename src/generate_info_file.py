...
sys.path.append("/root/catkin_ws/src/relaxed_ik/src/RelaxedIK")
...
if info_file_name == "":
    print(
        bcolors.FAIL
        + "info_file_name is a required field in start_here.py.  Please fill that in and run again."
        + bcolors.ENDC
    )
    exit(-1)
...
if urdf_file_name == "":
    print(
        bcolors.FAIL
        + "urdf_file_name is a required field in start_here.py.  Please fill that in and run again."
        + bcolors.ENDC
    )
    exit(-1)
else:
...
if fixed_frame == "":
    print(
        bcolors.FAIL
        + "fixed_frame is a required field in start_here.py.  Please fill that in and run again."
        + bcolors.ENDC
    )
    exit(-1)
else:
...
if len(joint_names) == 0:
    print(
        bcolors.FAIL
        + "joint_names is a required field in start_here.py.  Please fill that in and run again."
        + bcolors.ENDC
    )
    exit(-1)
else:
...
if len(joint_ordering) == 0:
    print(
        bcolors.FAIL
        + "joint_ordering is a required field in start_here.py.  Please fill that in and run again."
        + bcolors.ENDC
    )
    exit(-1)
else:
...
if len(ee_fixed_joints) == 0:
    print(
        bcolors.FAIL
        + "ee_fixed_joints is a required field in start_here.py.  Please fill that in and run again."
        + bcolors.ENDC
    )
    exit(-1)
else:
...
if len(starting_config) == 0:
    print(
        bcolors.FAIL
        + "starting_config is a required field in start_here.py.  Please fill that in and run again."
        + bcolors.ENDC
    )
    exit(-1)
else:
...
if collision_file_name == "":
    print(
        bcolors.FAIL
        + "collision_file_name is a required field in start_here.py.  Please fill that in and run again."
        + bcolors.ENDC
    )
    exit(-1)
else:
...
vars = RelaxedIK_vars(
    "",
    path_to_src + "/RelaxedIK/urdfs/" + urdf_file_name,
    joint_names,
    ee_fixed_joints,
    joint_ordering,
    pre_config=True,
